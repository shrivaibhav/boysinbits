...
namespace g{struct v2_accessor_Alive_ExampleApp_ProgramItem_CategoryColor;}

namespace g{

// internal sealed class v2_accessor_Alive_ExampleApp_ProgramItem_CategoryColor :41
// {
...
struct v2_accessor_Alive_ExampleApp_ProgramItem_CategoryColor : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return v2_accessor_Alive_ExampleApp_ProgramItem_CategoryColor_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return v2_accessor_Alive_ExampleApp_ProgramItem_CategoryColor_typeof()->Init(), _name_; }

    void ctor_1();
    static v2_accessor_Alive_ExampleApp_ProgramItem_CategoryColor* New1();
};
// }
