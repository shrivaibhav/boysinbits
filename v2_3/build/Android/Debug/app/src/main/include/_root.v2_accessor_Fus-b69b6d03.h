...
namespace g{struct v2_accessor_Fuse_Controls_RangeControl_Value;}

namespace g{

// internal sealed class v2_accessor_Fuse_Controls_RangeControl_Value :131
// {
...
struct v2_accessor_Fuse_Controls_RangeControl_Value : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return v2_accessor_Fuse_Controls_RangeControl_Value_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return v2_accessor_Fuse_Controls_RangeControl_Value_typeof()->Init(), _name_; }

    void ctor_1();
    static v2_accessor_Fuse_Controls_RangeControl_Value* New1();
};
// }
