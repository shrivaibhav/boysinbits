...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\Clicked.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\Internal\Clicker.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\Internal\Helpers.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\WhileEdgeSwiped.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\KeepInView.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.9.0\RangeControls\LinearRangeBehavior.uno
// ----------------------------------------------------------------------------------------------------------------------
...
static void LinearRangeBehavior_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\1.9.0\\RangeControls\\LinearRangeBehavior.uno");
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.9.0\Scroller.uno
// ---------------------------------------------------------------------------------------------
...
{
    _delayStart = value;
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Scroller.DelayStart is no longer supported."), this, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.9.0\\Scroller.uno"), 49, uString::Const("set_DelayStart"));
}
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid scroller update"), NULL, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.9.0\\Scroller.uno"), 384, uString::Const("OnUpdated"));
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.9.0\\Scroller.uno"), 129, uString::Const("UpdatePointerEvents"));
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("inconsistent gesture state"), NULL, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.9.0\\Scroller.uno"), 136, uString::Const("UpdatePointerEvents"));
        else
        {
            uPtr(_gesture)->Dispose();
            _gesture = NULL;
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.9.0\Scroller.Actions.uno
// -----------------------------------------------------------------------------------------------------
...
static void ScrollTo_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.9.0\\Scroller.Actions.uno");
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\Swipe.uno
// -------------------------------------------------------------------------------
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("Element");
    ::STRINGS[9] = uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\1.9.0\\Swipe.uno");
    ::STRINGS[2] = uString::Const("OnRooted");
    ::TYPES[8] = ::g::Fuse::Elements::Element_typeof();
    type->SetDependencies(
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[3/*"Element"*/], __this->Parent(), __this, ::STRINGS[9/*"C:\\Users\\...*/], 262, ::STRINGS[2/*"OnRooted"*/]);
        return;
    }
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\Tapped.uno
// --------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.9.0\Pressed.uno
// ---------------------------------------------------------------------------------
