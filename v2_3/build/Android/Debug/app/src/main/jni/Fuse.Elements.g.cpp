...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Enums.uno
// -------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Element.Transform.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\AspectBoxSizing.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\BoxSizing.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Element.Layout.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Caching\Cache.Heuristic.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Caching\Cache.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Caching\ElementAtlasPool.uno
// --------------------------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.9.0\\Element.Drawing.uno"), 67, uString::Const("Draw"));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.9.0\\Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.9.0\\Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Caching\ElementAtlas.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Caching\ElementBatch.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Caching\ElementBatcher.uno
// ------------------------------------------------------------------------------------------------
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("C:/Users/Vaibhav/AppData/Local/Fusetools/Packages/Fuse.Elements/1.9.0/Caching/ElementBatcher.uno");
        ...
        {
            {
                while (enum4.MoveNext(::TYPES[18/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]))
                {
                    ...
                    if (emitNewBatch || (atlas == NULL))
                    {
                        ...
                        {
                            ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[11/*"BUG: atlas-...*/], 0, ::STRINGS[12/*"C:/Users/Va...*/], 253);
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\LayoutFunctions.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Element.HitTest.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\InteractiveTransform.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Element.ITreeRenderer.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\LayoutMasterBoxSizing.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\LimitBoxSizing.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Elements\1.9.0\Transforms.uno
// ------------------------------------------------------------------------------------
...
uObject* TranslationModes__OffsetMode::Subscribe(uObject* transform)
{
    ...
    uPtr(collection1)->Target = uAs< ::g::Fuse::Elements::Element*>(::g::Fuse::ITransformRelative::Target(uInterface(uPtr(transform), ::TYPES[27/*Fuse.ITransformRelative*/])), ::TYPES[19/*Fuse.Elements.Element*/]);
...
static void LayoutFunction__Subscription_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.9.0\\LayoutFunctions.uno");
