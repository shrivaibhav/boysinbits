...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\CircleLayout.uno
// -----------------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\GridLayout.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\ColumnLayout.uno
// -----------------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\DefaultLayout.uno
// ------------------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\DockLayout.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\WrapLayout.uno
// ---------------------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Vaibhav\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Panels\\1.9.0\\Layouts\\GridLayout.uno");
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\Layout.uno
// -----------------------------------------------------------------------------------------------
...
static void Layout_build(uType* type)
{
    ...
    ::TYPES[37] = ::g::Fuse::ISourceLocation_typeof();
    type->SetInterfaces(
        ::TYPES[37/*Fuse.ISourceLocation*/], offsetof(Layout_type, interface0));
    type->SetFields(1,
...
void Layout__FuseISourceLocationget_SourceNearest_fn(Layout* __this, uObject** __retval)
{
    ...
    if (__this->Container != NULL)
        return *__retval = ::g::Fuse::ISourceLocation::SourceNearest(uInterface(uPtr((uObject*)__this->Container), ::TYPES[37/*Fuse.ISourceLocation*/])), void();
...
// C:\Users\Vaibhav\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.9.0\Layouts\StackLayout.uno
// ----------------------------------------------------------------------------------------------------
...
::g::Uno::Float2 WrapLayout::Arrange(::g::Fuse::Visual* container, ::g::Fuse::LayoutParams lp, bool doArrange, ::g::Uno::Float4 padding)
{
    ...
    uArray* placements = uArray::New(::TYPES[38/*float4[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(container)->Children()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* minorSizes = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* elementOnRow = uArray::New(::TYPES[40/*int[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Node>*/])));
    uArray* majorRest = uArray::New(::TYPES[2/*float[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Node>*/])));
    ...
    for (int32_t j1 = majorStart; j1 < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(container->Children()), ::TYPES[39/*Uno.Collections.ICollection<Fuse.Node>*/])); ++j1)
