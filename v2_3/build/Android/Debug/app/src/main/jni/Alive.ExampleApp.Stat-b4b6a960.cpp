...
static void StatsPage__Template_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(StatsPage__Template, temp_eb9), 0,
...
void StatsPage__Template__New1_fn(StatsPage__Template* __this, uObject** __retval)
{
    ...
    __this->temp_eb9 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp2);
    ...
    temp16->add_Handler(uDelegate::New(::TYPES[2/*Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(__this->temp_eb9)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), __this->temp_eb9);
