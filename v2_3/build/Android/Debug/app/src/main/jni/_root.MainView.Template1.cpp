...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"Device"*/]);
}
...
{
    ::g::Device* __self1 = ::g::Device::New5(uPtr(__this->__parent1)->router);
