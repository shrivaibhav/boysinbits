...
{
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"SignIn"*/]);
}

static void MainView__Template_build(uType* type)
{
    ::STRINGS[0] = uString::Const("SignIn");
...
{
    ::g::SignIn* __self1 = ::g::SignIn::New5(uPtr(__this->__parent1)->router);
