...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp5 = new global::Fuse.Reactive.Data("goToSchedule");
        var temp6 = new global::Fuse.Reactive.Data("goToSettings");
        var temp7 = new global::Fuse.Reactive.JavaScript(__g_nametable);
        var temp8 = new global::Alive.FallbackTheme();
        ...
        var temp12 = new global::Alive.LightTheme();
        var temp13 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp3, Fuse.Reactive.BindingMode.Read);
        router = new global::Fuse.Navigation.Router();
        drawer = new global::Alive.Drawer(temp4);
        var temp14 = new global::Alive.ExampleApp.DrawerItem();
        temp_eb0 = new global::Fuse.Reactive.EventBinding(temp5);
        var temp15 = new global::Alive.ExampleApp.DrawerItem();
        ...
        temp9.Children.Add(router);
        temp9.Children.Add(drawer);
        ...
        drawer.SubtreeNodes.Add(temp16);
        ...
        temp15.Text = "Settings";
        temp15.SourceLineNumber = 42;
        temp15.SourceFileName = "MainView.ux";
        global::Fuse.Gestures.Clicked.AddHandler(temp15, temp_eb1.OnEvent);
        temp15.Bindings.Add(temp_eb1);
        temp6.SourceLineNumber = 42;
        temp6.SourceFileName = "MainView.ux";
        temp16.DefaultPath = "select";
        temp16.SourceLineNumber = 45;
        temp16.SourceFileName = "MainView.ux";
        temp16.Templates.Add(select);
        temp16.Templates.Add(program);
        temp16.Templates.Add(details);
        temp16.Templates.Add(schedule);
        temp16.Templates.Add(stats);
        temp16.Templates.Add(settings);
