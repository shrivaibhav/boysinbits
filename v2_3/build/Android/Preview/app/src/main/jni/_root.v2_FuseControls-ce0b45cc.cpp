...
// internal sealed class v2_FuseControlsShape_Color_Property :196
// {
...
// public v2_FuseControlsShape_Color_Property(Fuse.Controls.Shape obj, Uno.UX.Selector name) :199
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :201
...
{
    uStackFrame __("v2_FuseControlsShape_Color_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Shape*>(obj, ::TYPES[0/*Fuse.Controls.Shape*/]))->Color(), void();
}

// public v2_FuseControlsShape_Color_Property New(Fuse.Controls.Shape obj, Uno.UX.Selector name) :199
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :202
...
{
    uStackFrame __("v2_FuseControlsShape_Color_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
// public v2_FuseControlsShape_Color_Property(Fuse.Controls.Shape obj, Uno.UX.Selector name) [instance] :199
...
// public v2_FuseControlsShape_Color_Property New(Fuse.Controls.Shape obj, Uno.UX.Selector name) [static] :199
