...
static void MainView__cctor_1_fn(uType* __type)
{
    ...
    MainView::__g_static_nametable1_ = uArray::Init<uString*>(::g::Uno::String_typeof()->Array(), 4, uString::Const("router"), uString::Const("drawer"), uString::Const("temp_eb0"), uString::Const("temp_eb1"));
    ...
    MainView::__selector2_ = ::g::Uno::UX::Selector__op_Implicit1(uString::Const("drawer"));
...
static void MainView_build(uType* type)
{
    ...
    type->SetFields(7,
        ...
        ::g::Alive::Drawer_typeof(), offsetof(MainView, drawer), 0,
...
// private void InitializeUX() :367
void MainView__InitializeUX_fn(MainView* __this)
{
    __this->InitializeUX();
}

// public MainView New() :363
...
// private void InitializeUX() [instance] :367
void MainView::InitializeUX()
{
    ...
    ::g::Fuse::Reactive::Data* temp5 = ::g::Fuse::Reactive::Data::New1(uString::Const("goToSchedule"));
    ::g::Fuse::Reactive::Data* temp6 = ::g::Fuse::Reactive::Data::New1(uString::Const("goToSettings"));
    ::g::Fuse::Reactive::JavaScript* temp7 = ::g::Fuse::Reactive::JavaScript::New2(__g_nametable1);
    ::g::Alive::FallbackTheme* temp8 = ::g::Alive::FallbackTheme::New5();
    ...
    ::g::Alive::LightTheme* temp12 = ::g::Alive::LightTheme::New4();
    ::g::Fuse::Reactive::DataBinding* temp13 = ::g::Fuse::Reactive::DataBinding::New1(temp1_Value_inst, (uObject*)temp3, 1);
    router = ::g::Fuse::Navigation::Router::New2();
    drawer = ::g::Alive::Drawer::New5(temp4);
    ::g::Alive::ExampleApp::DrawerItem* temp14 = ::g::Alive::ExampleApp::DrawerItem::New4();
    temp_eb0 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp5);
    ::g::Alive::ExampleApp::DrawerItem* temp15 = ::g::Alive::ExampleApp::DrawerItem::New4();
    temp_eb1 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp6);
    ::g::Fuse::Controls::Navigator* temp16 = ::g::Fuse::Controls::Navigator::New4();
    MainView__Template* select = MainView__Template::New2(this, this);
    MainView__Template1* program = MainView__Template1::New2(this, this);
    MainView__Template2* details = MainView__Template2::New2(this, this);
    MainView__Template3* schedule = MainView__Template3::New2(this, this);
    MainView__Template4* stats = MainView__Template4::New2(this, this);
    MainView__Template5* settings = MainView__Template5::New2(this, this);
    temp7->Code(uString::Const("\n"
        ...
        "\t"));
    temp7->LineNumber(2);
    temp7->FileName(uString::Const("MainView.ux"));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL)), router);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL)), drawer);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Nodes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL)), temp12);
    ...
    uPtr(router)->SourceLineNumber(38);
    uPtr(router)->SourceFileName(uString::Const("MainView.ux"));
    uPtr(drawer)->Alignment(0);
    uPtr(drawer)->Name(MainView::__selector2_);
    uPtr(drawer)->SourceLineNumber(39);
    uPtr(drawer)->SourceFileName(uString::Const("MainView.ux"));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(drawer)->SubtreeNodes()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL)), temp16);
    temp4->SourceLineNumber(40);
    temp4->SourceFileName(uString::Const("MainView.ux"));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL)), temp14);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL)), temp15);
    temp14->Text(uString::Const("My Home"));
    temp14->SourceLineNumber(41);
    temp14->SourceFileName(uString::Const("MainView.ux"));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp14, uDelegate::New(::g::Fuse::Gestures::ClickedHandler_typeof(), (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb0)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp14->Bindings()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL)), temp_eb0);
    temp5->SourceLineNumber(41);
    temp5->SourceFileName(uString::Const("MainView.ux"));
    temp15->Text(uString::Const("Settings"));
    temp15->SourceLineNumber(42);
    temp15->SourceFileName(uString::Const("MainView.ux"));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp15, uDelegate::New(::g::Fuse::Gestures::ClickedHandler_typeof(), (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb1)));
    ...
    temp16->DefaultPath(uString::Const("select"));
    temp16->SourceLineNumber(45);
    temp16->SourceFileName(uString::Const("MainView.ux"));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), select);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), program);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), details);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), schedule);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), stats);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), settings);
...
// public MainView New() [static] :363
