// This file was generated based on build/Android/Preview/cache/ux15/Alive.ExampleApp.SettingsPage.g.uno.
...
static void SettingsPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)SettingsPage__New6_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("Alive.ExampleApp.SettingsPage", ".ctor()");
    ctor_8();
    InitializeUX1();
}
...
{
    uStackFrame __("Alive.ExampleApp.SettingsPage", "InitializeUX()");
