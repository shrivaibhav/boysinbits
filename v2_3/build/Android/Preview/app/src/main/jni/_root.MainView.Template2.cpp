...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"details"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("details");
...
void MainView__Template2__New1_fn(MainView__Template2* __this, uObject** __retval)
{
    ...
    ::g::Alive::ExampleApp::DetailsPage* __self1 = ::g::Alive::ExampleApp::DetailsPage::New6(uPtr(__this->__parent1)->router);
