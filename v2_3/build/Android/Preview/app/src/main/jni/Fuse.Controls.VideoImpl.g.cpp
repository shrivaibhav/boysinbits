...
// C:\Users\hp laptop\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.9.0\IVideoPlayer.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\hp laptop\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.9.0\VideoContainer.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\hp laptop\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.9.0\VideoVisual.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\hp laptop\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.9.0\VideoDiskCache.uno
// ------------------------------------------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:/Users/hp laptop/AppData/Local/Fusetools/Packages/Fuse.Controls.Video/1.9.0/VideoDiskCache.uno");
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[15/*Uno.Collections.Dictionary<string, string>.Enumerator*/]))
                {
                    ...
                    {
                        ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[16/*Uno.Collections.KeyValuePair<string, string>*/])), 0, ::STRINGS[3/*"C:/Users/hp...*/], 29);
...
// C:\Users\hp laptop\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.9.0\VideoLoader.uno
// ---------------------------------------------------------------------------------------------
...
void VideoVisual__Draw_fn(VideoVisual* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(uString::Const("StretchMode.Scale9 is deprecated for video-visual"), __this, uString::Const("C:\\Users\\hp laptop\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\1.9.0\\VideoVisual.uno"), 336, uString::Const("Draw"));
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(uString::Const("Video error"), e, __this, uString::Const("C:\\Users\\hp laptop\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\1.9.0\\VideoVisual.uno"), 116, uString::Const("Fuse.Controls.VideoImpl.IVideoCallbacks.OnError"));
}
...
{
    ::g::Fuse::Diagnostics::Unsupported(uString::Const("IPlayback.PlayTo(double) not supported in Fuse.Controls.Video"), __this, uString::Const("C:\\Users\\hp laptop\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\1.9.0\\VideoVisual.uno"), 186, uString::Const("Fuse.Triggers.IPlayback.PlayTo"));
}
