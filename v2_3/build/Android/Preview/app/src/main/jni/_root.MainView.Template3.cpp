...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"schedule"*/]);
}
...
void MainView__Template3__New1_fn(MainView__Template3* __this, uObject** __retval)
{
    ...
    ::g::Alive::ExampleApp::SchedulePage* __self1 = ::g::Alive::ExampleApp::SchedulePage::New6(uPtr(__this->__parent1)->drawer, uPtr(__this->__parent1)->router);
