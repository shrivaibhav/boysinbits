// This file was generated based on build/Android/Preview/cache/ux15/Alive.ExampleApp.CategoryPreviewCard.g.uno.
...
static void CategoryPreviewCard_build(uType* type)
{
    ...
    type->SetFields(124,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(CategoryPreviewCard, temp_eb6), 0);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)CategoryPreviewCard__New6_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("Alive.ExampleApp.CategoryPreviewCard", ".ctor()");
    ctor_9();
    InitializeUX2();
}
...
{
    uStackFrame __("Alive.ExampleApp.CategoryPreviewCard", "InitializeUX()");
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(this, uDelegate::New(::TYPES[0/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb6)));
    ...
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::v2_bundle::event25df1c2a0()));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb6);
}
