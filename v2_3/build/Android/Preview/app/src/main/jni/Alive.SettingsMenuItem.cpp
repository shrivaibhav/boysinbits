// This file was generated based on build/Android/Preview/cache/ux15/Alive.SettingsMenuItem.g.uno.
...
static void SettingsMenuItem_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_Label", NULL, (void*)SettingsMenuItem__get_Label_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Label", NULL, (void*)SettingsMenuItem__set_Label_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction(".ctor", NULL, (void*)SettingsMenuItem__New6_fn, 0, true, type, 0),
        new uFunction("SetLabel", NULL, (void*)SettingsMenuItem__SetLabel_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()));
}
...
{
    uStackFrame __("Alive.SettingsMenuItem", ".ctor()");
    ctor_9();
    InitializeUX2();
}
...
{
    uStackFrame __("Alive.SettingsMenuItem", "InitializeUX()");
...
{
    uStackFrame __("Alive.SettingsMenuItem", "set_Label(string)");
    SetLabel(value, NULL);
}
...
{
    uStackFrame __("Alive.SettingsMenuItem", "SetLabel(string,Uno.UX.IPropertyListener)");
