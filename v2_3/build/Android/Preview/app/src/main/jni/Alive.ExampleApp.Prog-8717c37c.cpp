...
static void ProgramPage__Template1_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(ProgramPage__Template1, temp_eb3), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(ProgramPage__Template1, temp_eb4), 0,
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ProgramPage__Template1__New2_fn, 0, true, type, 2, ::g::Alive::ExampleApp::ProgramPage_typeof(), ::g::Alive::ExampleApp::ProgramPage_typeof()));
}
...
// public Template1(Alive.ExampleApp.ProgramPage parent, Alive.ExampleApp.ProgramPage parentInstance) :50
...
{
    uStackFrame __("Alive.ExampleApp.ProgramPage.Template1", "New()");
    ...
    __this->temp_eb3 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp2);
    ...
    __this->temp_eb4 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp9);
    ...
    temp11->add_Handler(uDelegate::New(::TYPES[0/*Fuse.UserEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(__this->temp_eb3)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp11->Bindings()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Binding>*/]), __this->temp_eb3);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp, uDelegate::New(::TYPES[2/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(__this->temp_eb4)));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Binding>*/]), __this->temp_eb4);
...
// public Template1 New(Alive.ExampleApp.ProgramPage parent, Alive.ExampleApp.ProgramPage parentInstance) :50
...
// public Template1(Alive.ExampleApp.ProgramPage parent, Alive.ExampleApp.ProgramPage parentInstance) [instance] :50
...
// public Template1 New(Alive.ExampleApp.ProgramPage parent, Alive.ExampleApp.ProgramPage parentInstance) [static] :50
