...
{
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"select"*/]);
}

static void MainView__Template_build(uType* type)
{
    ::STRINGS[0] = uString::Const("select");
...
void MainView__Template__New1_fn(MainView__Template* __this, uObject** __retval)
{
    ...
    ::g::Alive::ExampleApp::SelectCategoryPage* __self1 = ::g::Alive::ExampleApp::SelectCategoryPage::New6(uPtr(__this->__parent1)->router);
