...
static void StatsPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StatsPage__New6_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("Alive.ExampleApp.StatsPage", ".ctor()");
    ctor_8();
    InitializeUX1();
}
...
{
    uStackFrame __("Alive.ExampleApp.StatsPage", "InitializeUX()");
