...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"program"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("program");
...
void MainView__Template1__New1_fn(MainView__Template1* __this, uObject** __retval)
{
    ...
    ::g::Alive::ExampleApp::ProgramPage* __self1 = ::g::Alive::ExampleApp::ProgramPage::New6(uPtr(__this->__parent1)->router);
