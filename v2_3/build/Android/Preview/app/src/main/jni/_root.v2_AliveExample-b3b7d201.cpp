...
// internal sealed class v2_AliveExampleAppProgramItem_Person_Property :302
// {
...
// public v2_AliveExampleAppProgramItem_Person_Property(Alive.ExampleApp.ProgramItem obj, Uno.UX.Selector name) :305
void v2_AliveExampleAppProgramItem_Person_Property__ctor_3_fn(v2_AliveExampleAppProgramItem_Person_Property* __this, ::g::Alive::ExampleApp::ProgramItem* obj, ::g::Uno::UX::Selector* name)
{
...
{
    uStackFrame __("v2_AliveExampleAppProgramItem_Person_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Alive::ExampleApp::ProgramItem*>(obj, ::TYPES[0/*Alive.ExampleApp.ProgramItem*/]))->Person(), void();
}

// public v2_AliveExampleAppProgramItem_Person_Property New(Alive.ExampleApp.ProgramItem obj, Uno.UX.Selector name) :305
void v2_AliveExampleAppProgramItem_Person_Property__New1_fn(::g::Alive::ExampleApp::ProgramItem* obj, ::g::Uno::UX::Selector* name, v2_AliveExampleAppProgramItem_Person_Property** __retval)
{
    *__retval = v2_AliveExampleAppProgramItem_Person_Property::New1(obj, *name);
}
...
{
    uStackFrame __("v2_AliveExampleAppProgramItem_Person_Property", "Set(Uno.UX.PropertyObject,string,Uno.UX.IPropertyListener)");
...
// public v2_AliveExampleAppProgramItem_Person_Property(Alive.ExampleApp.ProgramItem obj, Uno.UX.Selector name) [instance] :305
void v2_AliveExampleAppProgramItem_Person_Property::ctor_3(::g::Alive::ExampleApp::ProgramItem* obj, ::g::Uno::UX::Selector name)
{
    ctor_2(name);
    _obj = obj;
}

// public v2_AliveExampleAppProgramItem_Person_Property New(Alive.ExampleApp.ProgramItem obj, Uno.UX.Selector name) [static] :305
v2_AliveExampleAppProgramItem_Person_Property* v2_AliveExampleAppProgramItem_Person_Property::New1(::g::Alive::ExampleApp::ProgramItem* obj, ::g::Uno::UX::Selector name)
{
    v2_AliveExampleAppProgramItem_Person_Property* obj1 = (v2_AliveExampleAppProgramItem_Person_Property*)uNew(v2_AliveExampleAppProgramItem_Person_Property_typeof());
