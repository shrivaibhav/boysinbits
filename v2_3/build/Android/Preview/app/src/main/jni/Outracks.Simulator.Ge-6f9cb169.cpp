// This file was generated based on build/Android/Preview/preamble/$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("10.1.80.213");
    ::STRINGS[2] = uString::Const("192.168.218.1");
    ::STRINGS[3] = uString::Const("192.168.24.1");
    ::STRINGS[4] = uString::Const("G:\\Eliot v2\\v2\\v2.unoproj");
    ::STRINGS[5] = uString::Const("v2");
...
void GeneratedApplication::ctor_5()
{
    ...
    ctor_4(uArray::Init< ::g::Uno::Net::IPEndPoint*>(::TYPES[0/*Uno.Net.IPEndPoint[]*/], 4, (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[0/*"127.0.0.1"*/]), 12124), (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[1/*"10.1.80.213"*/]), 12124), (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[2/*"192.168.218.1"*/]), 12124), (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[3/*"192.168.24.1"*/]), 12124)), ::STRINGS[4/*"G:\\Eliot v...*/], uArray::Init<uString*>(::TYPES[1/*string[]*/], 0));
    ::g::Outracks::Simulator::Runtime::Bundle::Initialize(::STRINGS[5/*"v2"*/]);
