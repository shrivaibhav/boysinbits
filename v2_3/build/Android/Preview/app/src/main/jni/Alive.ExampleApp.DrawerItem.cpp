...
static void DrawerItem_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction(".ctor", NULL, (void*)DrawerItem__New4_fn, 0, true, type, 0),
        new uFunction("SetText", NULL, (void*)DrawerItem__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Text", NULL, (void*)DrawerItem__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)DrawerItem__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Alive.ExampleApp.DrawerItem", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("Alive.ExampleApp.DrawerItem", "InitializeUX()");
...
{
    uStackFrame __("Alive.ExampleApp.DrawerItem", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("Alive.ExampleApp.DrawerItem", "set_Text(string)");
    SetText(value, NULL);
}
